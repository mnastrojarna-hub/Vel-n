...
class EventKind(str, Enum):
    ...
    LTE_RESET = "LTE_RESET"
    LTE_MODE = "LTE_MODE"
    NET_FIX = "NET_FIX"                          # health odstranil cizí výchozí trasu (eth0) — internet jen LTE (route_fix)                        # přepnutí režimu modemu QMI↔RNDIS (health automaticky / Velín `lte_mode`)
