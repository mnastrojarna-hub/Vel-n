...
MG.i18n = (function () {
  ...
  const S = {
    cs: { banner: 'Řídicí jednotka nedostupná — zkuste to prosím za chvíli',
      ...
      hint2: 'Kód k výbavě otevře šatnu · kód k motorce otevře vaši garáž s vaší motorkou.',
      clear: 'SMAZAT', tap: 'Klepnutím zavřete', verifying: 'Ověřuji kód…', opened: 'Otevřeno', support: 'Podpora',
      okAcc: 'Po vyzvednutí výbavy zavřete šatnu a zadejte kód k motorce.', okMoto: 'Příjemnou cestu! 🏍️',
    ...
    en: { banner: 'Control unit unavailable — please try again in a moment',
      ...
      hint2: 'The gear code opens the changing room · the motorcycle code opens your garage with your bike.',
      clear: 'CLEAR', tap: 'Tap to close', verifying: 'Checking code…', opened: 'Open', support: 'Support',
      okAcc: 'After collecting your gear, close the changing room and enter the motorcycle code.', okMoto: 'Have a great ride! 🏍️',
      acc: 'Changing room', box: 'Bay {n}', zone: 'Zone {n}', closed: 'closed', open: 'open', unknown: 'unknown',
    ...
    de: { banner: 'Steuereinheit nicht erreichbar — bitte versuchen Sie es gleich noch einmal',
      ...
      hint2: 'Der Ausrüstungscode öffnet die Umkleide · der Motorradcode öffnet Ihre Garage mit Ihrem Motorrad.',
      clear: 'LÖSCHEN', tap: 'Zum Schließen tippen', verifying: 'Code wird geprüft…', opened: 'Geöffnet', support: 'Support',
      okAcc: 'Nach der Entnahme der Ausrüstung die Umkleide schließen und den Motorradcode eingeben.', okMoto: 'Gute Fahrt! 🏍️',
    ...
    es: { banner: 'Unidad de control no disponible — inténtelo de nuevo en un momento',
      ...
      hint2: 'El código del equipo abre el vestuario · el código de la moto abre su garaje con su moto.',
      clear: 'BORRAR', tap: 'Toque para cerrar', verifying: 'Comprobando código…', opened: 'Abierto', support: 'Soporte',
      okAcc: 'Tras recoger el equipo, cierre el vestuario e introduzca el código de la moto.', okMoto: '¡Buen viaje! 🏍️',
    ...
    fr: { banner: 'Unité de commande indisponible — réessayez dans un instant',
      ...
      hint2: 'Le code équipement ouvre le vestiaire · le code moto ouvre votre garage avec votre moto.',
      clear: 'EFFACER', tap: 'Touchez pour fermer', verifying: 'Vérification du code…', opened: 'Ouvert', support: 'Assistance',
      okAcc: 'Après avoir pris votre équipement, fermez le vestiaire et saisissez le code moto.', okMoto: 'Bonne route ! 🏍️',
    ...
    nl: { banner: 'Besturingseenheid niet bereikbaar — probeer het zo opnieuw',
      ...
      hint2: 'De uitrustingscode opent de kleedkamer · de motorcode opent uw garage met uw motor.',
      clear: 'WISSEN', tap: 'Tik om te sluiten', verifying: 'Code controleren…', opened: 'Geopend', support: 'Support',
      okAcc: 'Sluit na het pakken van uw uitrusting de kleedkamer en voer de motorcode in.', okMoto: 'Goede rit! 🏍️',
    ...
    pl: { banner: 'Jednostka sterująca niedostępna — spróbuj ponownie za chwilę',
      ...
      hint2: 'Kod do wyposażenia otwiera szatnię · kod do motocykla otwiera Twój garaż z Twoim motocyklem.',
      clear: 'USUŃ', tap: 'Dotknij, aby zamknąć', verifying: 'Sprawdzam kod…', opened: 'Otwarte', support: 'Wsparcie',
      okAcc: 'Po odebraniu wyposażenia zamknij szatnię i wpisz kod do motocykla.', okMoto: 'Miłej jazdy! 🏍️',
    ...
    uk: { banner: 'Блок керування недоступний — спробуйте ще раз за хвилину',
      ...
      hint2: 'Код до екіпірування відкриває роздягальню · код до мотоцикла відкриває ваш гараж із вашим мотоциклом.',
      clear: 'СТЕРТИ', tap: 'Торкніться, щоб закрити', verifying: 'Перевіряю код…', opened: 'Відкрито', support: 'Підтримка',
      okAcc: 'Після отримання екіпірування зачиніть роздягальню та введіть код до мотоцикла.', okMoto: 'Гарної дороги! 🏍️',
