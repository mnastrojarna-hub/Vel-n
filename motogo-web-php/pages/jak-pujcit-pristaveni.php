...
echo renderHead('Přistavení motocyklu | MotoGo24', 'Přistavení motorky na domluvené místo. Půjčovna motorek Motogo24 na Vysočině – doručení motocyklu po celém Česku.');
echo renderHeader();

$bc = renderBreadcrumb([['href'=>'/', 'label'=>'Domů'], ['href'=>'/jak-pujcit', 'label'=>'Jak si půjčit'], 'Přistavení motocyklu']);
