...
echo renderHead('Nájemní smlouva a kauce | MotoGo24', 'Nájemní smlouva a férové podmínky bez kauce v půjčovně motorek Motogo24 na Vysočině. Pojištění v ceně, výbava pro řidiče.');
echo renderHeader();

$bc = renderBreadcrumb([['href'=>'/', 'label'=>'Domů'], ['href'=>'/jak-pujcit', 'label'=>'Jak si půjčit'], 'Dokumenty a návody']);
