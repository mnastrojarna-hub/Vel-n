<?php
// ===== MotoGo24 Web PHP — Postup půjčení motorky =====

echo renderHead('Postup půjčení motorky | MotoGo24', 'Postup půjčení motorky v půjčovně Motogo24 na Vysočině. Online rezervace, výbava v ceně, bez kauce, nonstop provoz.');
echo renderHeader();

$bc = renderBreadcrumb([['href'=>'/', 'label'=>'Domů'], ['href'=>'/jak-pujcit', 'label'=>'Jak si půjčit'], 'Postup půjčení motorky']);
