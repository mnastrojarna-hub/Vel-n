...
$rezKeys = [
    ...
    'steps.cancelBooking','steps.cancelConfirm','steps.cancelFailed','steps.cancelNotCancelable','steps.docsOptionalNote','steps.staffedBranchLabel','steps.staffedBranchNote','steps.docsSpeedupQuestion','steps.docsAlreadyUploaded',
