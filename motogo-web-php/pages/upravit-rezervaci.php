...
$keys = [
    ...
    'editRez.pay.notFound','editRez.pay.forbidden','editRez.pay.stale','editRez.pay.amountMismatch','editRez.pay.motoUnavailable','editRez.pay.wrongStatus','editRez.pay.authRequired',
