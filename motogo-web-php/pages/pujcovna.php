<?php
// ===== MotoGo24 Web PHP — Stránka Půjčovna motorek =====
// Odpovídá pages-pujcovna.js

$bc = renderBreadcrumb([['label' => 'Domů', 'href' => '/'], 'Půjčovna motorek']);
...
$benefits = '<section><h2>Proč si půjčit motorku u nás</h2><div class="gr6">' .
    ...
    '<p>&nbsp;</p><p>' .
    '<a class="btn btndark" href="' . BASE_URL . '/katalog">Zobrazit motorky k pronájmu</a> ' .
    '<a class="btn btngreen pulse" href="' . BASE_URL . '/rezervace">REZERVOVAT</a></p></section>';
