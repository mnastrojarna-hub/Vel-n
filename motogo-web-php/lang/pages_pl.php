...
return [
    'pages' => [
        ...
        'home' => [
            ...
            'signposts' => [
                ['icon' => 'gfx/vyber-motorku.svg', 'title' => 'Katalog motocykli', 'text' => 'Zobacz naszą ofertę motocykli do wynajęcia — od sportowych po turystyczne.', 'btn' => 'KATALOG MOTOCYKLI', 'href' => '/katalog'],
                ['icon' => 'gfx/potvrzeni-rezervace.svg', 'title' => 'Jak wypożyczyć motocykl', 'text' => 'Prosty proces: wybierz motocykl, zarezerwuj i ruszaj.', 'btn' => 'JAK WYPOŻYCZYĆ', 'href' => '/jak-pujcit'],
                ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Rezerwacja online', 'text' => 'Zarezerwuj motocykl przez nasz prosty system online.', 'btn' => 'ZAREZERWUJ MOTOCYKL', 'href' => '/rezervace'],
                ['icon' => 'gfx/kontakt.svg', 'title' => 'Kontakt i mapa', 'text' => 'Odwiedź naszą wypożyczalnię w Pelhřimovie lub skontaktuj się z nami.', 'btn' => 'KONTAKT', 'href' => '/kontakt'],
                ['icon' => 'gfx/faq.svg', 'title' => 'Najczęściej zadawane pytania', 'text' => 'Najczęstsze pytania o wynajem motocykla zebrane w jednym miejscu.', 'btn' => 'FAQ', 'href' => '/jak-pujcit/faq'],
                ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => 'Trasy motocyklowe', 'text' => 'Odkryj najlepsze trasy motocyklowe w Czechach dla turystów i lokalnych.', 'btn' => 'TRASY MOTOCYKLOWE', 'href' => '/blog'],
            ],
            'motos_section' => [
            ...
            'process' => [
                ...
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Wybierz', 'text' => 'Wybierz idealny motocykl z naszej oferty motocykli do wynajęcia.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Zarezerwuj', 'text' => 'Zarezerwuj motocykl przez nasz prosty system online.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '3. Odbierz', 'text' => 'Odbierz motocykl w naszej wypożyczalni w Pelhřimovie.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '4. Ciesz się jazdą', 'text' => 'Poczuj wolność i odkryj Czechy na motocyklach do wynajęcia.'],
                ],
            ],
            'faq' => [
        ...
        'pujcovna' => [
            ...
            'benefits' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Rezerwacja online', 'text' => 'w kilka kliknięć'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => 'Wyposażenie kierowcy w cenie', 'text' => 'kask, kurtka, spodnie i rękawice'],
                    ...
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => 'Dostawa i odbiór motocykla', 'text' => 'w umówione miejsce'],
                ],
            ],
            'process' => [
                'title' => 'Jak działa wypożyczanie w Vysočina',
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Wybierz motocykl', 'text' => 'Zobacz naszą ofertę i wybierz typ, który ci odpowiada, twoim doświadczeniom i prawu jazdy.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Zarezerwuj online', 'text' => 'Zarezerwuj według daty lub konkretnego motocykla, który chcesz wypożyczyć.'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => '3. Wybierz wyposażenie', 'text' => 'Wyposażenie kierowcy jest w cenie, dla pasażera za dopłatą. Rozmiar wybierzesz na miejscu.'],
                    ['icon' => 'gfx/zaplat.svg', 'title' => '4. Zapłać', 'text' => 'Zapłać prosto online przez bramkę płatności.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '5. Odbierz motocykl', 'text' => 'Odbierz motocykl bezpośrednio w wypożyczalni lub w wybranym przy rezerwacji miejscu.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '6. Ciesz się jazdą', 'text' => 'Wyrusz w drogę, odkrywaj nowe doświadczenia i ciesz się pełną wolnością na dwóch kołach.'],
                    ['icon' => 'gfx/vrat-motorku-vcas.svg', 'title' => '7. Zwróć motocykl', 'text' => 'Po prostu zwróć motocykl w umówionym dniu – w wypożyczalni lub w umówionym miejscu.'],
                    ['icon' => 'gfx/sleva-na-pristi-jizdu.svg', 'title' => 'Zniżka na kolejną jazdę', 'text' => 'Po zwrocie motocykla automatycznie wyślemy ci kod rabatowy 200 Kč na kolejną rezerwację.'],
                ],
            ],
            'faq' => [
                'title' => 'Najczęściej zadawane pytania',
