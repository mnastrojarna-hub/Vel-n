...
return [
    'pages' => [
        ...
        'home' => [
            ...
            'signposts' => [
                ['icon' => 'gfx/vyber-motorku.svg', 'title' => 'Motorradkatalog', 'text' => 'Sieh dir unser Angebot an Mietmotorrädern an – von Sport- bis Tourenmodellen.', 'btn' => 'MOTORRADKATALOG', 'href' => '/katalog'],
                ['icon' => 'gfx/potvrzeni-rezervace.svg', 'title' => 'Wie miete ich ein Motorrad', 'text' => 'Einfacher Ablauf: Motorrad auswählen, reservieren und losfahren.', 'btn' => 'WIE MIETE ICH', 'href' => '/jak-pujcit'],
                ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Online-Reservierung', 'text' => 'Reserviere ein Motorrad über unser einfaches Online-System.', 'btn' => 'MOTORRAD RESERVIEREN', 'href' => '/rezervace'],
                ['icon' => 'gfx/kontakt.svg', 'title' => 'Kontakt und Karte', 'text' => 'Besuche unsere Motorradvermietung in Pelhřimov oder kontaktiere uns.', 'btn' => 'KONTAKT', 'href' => '/kontakt'],
                ['icon' => 'gfx/faq.svg', 'title' => 'Häufige Fragen', 'text' => 'Die häufigsten Fragen zur Motorradmiete übersichtlich an einem Ort.', 'btn' => 'FAQ', 'href' => '/jak-pujcit/faq'],
                ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => 'Motorradtouren', 'text' => 'Entdecke die besten Motorradrouten in Tschechien – für Touristen und Einheimische.', 'btn' => 'MOTORRADROUTEN', 'href' => '/blog'],
            ],
            'motos_section' => [
            ...
            'process' => [
                ...
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Auswählen', 'text' => 'Wähle dein ideales Motorrad aus unserem Mietangebot.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Reservieren', 'text' => 'Reserviere dein Motorrad über unser einfaches Online-System.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '3. Übernahme', 'text' => 'Übernimm das Motorrad in unserer Vermietung in Pelhřimov.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '4. Genieße die Fahrt', 'text' => 'Genieße die Freiheit und entdecke Tschechien auf dem Mietmotorrad.'],
                ],
            ],
            'faq' => [
        ...
        'pujcovna' => [
            ...
            'benefits' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Online-Reservierung', 'text' => 'mit wenigen Klicks'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => 'Fahrerausrüstung im Preis', 'text' => 'Helm, Jacke, Hose und Handschuhe'],
                    ...
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => 'Lieferung und Abholung', 'text' => 'an einen vereinbarten Ort'],
                ],
            ],
            'process' => [
                'title' => 'Wie die Vermietung in Vysočina abläuft',
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Motorrad auswählen', 'text' => 'Sieh dir unser Angebot an und wähle den Typ, der zu dir, deiner Erfahrung und deiner Fahrerlaubnis passt.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Online reservieren', 'text' => 'Reserviere nach Datum oder nach einem konkreten Motorrad, das du mieten möchtest.'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => '3. Ausrüstung wählen', 'text' => 'Fahrerausrüstung ist im Preis enthalten, Sozius-Ausrüstung gegen Aufpreis. Die Größe wählst du vor Ort.'],
                    ['icon' => 'gfx/zaplat.svg', 'title' => '4. Bezahlen', 'text' => 'Zahle einfach online über das Zahlungsportal.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '5. Motorrad übernehmen', 'text' => 'Übernimm das Motorrad direkt in der Vermietung oder am bei der Reservierung gewählten Ort.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '6. Genieße die Fahrt', 'text' => 'Mach dich auf den Weg, sammle neue Erlebnisse und genieße die volle Freiheit auf zwei Rädern.'],
                    ['icon' => 'gfx/vrat-motorku-vcas.svg', 'title' => '7. Motorrad zurückgeben', 'text' => 'Gib das Motorrad einfach am vereinbarten Tag zurück – in der Vermietung oder an einem vereinbarten Ort.'],
                    ['icon' => 'gfx/sleva-na-pristi-jizdu.svg', 'title' => 'Rabatt für die nächste Fahrt', 'text' => 'Nach der Rückgabe des Motorrads schicken wir dir automatisch einen Rabattcode über 200 Kč für die nächste Reservierung.'],
                ],
            ],
            'faq' => [
                'title' => 'Häufig gestellte Fragen',
