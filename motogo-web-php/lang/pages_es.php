...
return [
    'pages' => array_merge($c['pages'], [
        ...
        'home' => [
            ...
            'signposts' => [
                ['icon' => 'gfx/ico-katalog.svg', 'title' => 'Catálogo de motos', 'text' => 'Mira nuestra oferta de motos de alquiler — desde modelos sport hasta de turismo.', 'btn' => 'CATÁLOGO DE MOTOS', 'href' => '/katalog'],
                ['icon' => 'gfx/ico-jak.svg', 'title' => 'Cómo alquilar una moto', 'text' => 'Proceso sencillo: elige una moto, reserva y sal a la carretera.', 'btn' => 'CÓMO ALQUILAR', 'href' => '/jak-pujcit'],
                ['icon' => 'gfx/ico-rezervace.svg', 'title' => 'Reserva online', 'text' => 'Reserva tu moto a través de nuestro sencillo sistema online.', 'btn' => 'RESERVAR MOTO', 'href' => '/rezervace'],
                ['icon' => 'gfx/ico-kontakt.svg', 'title' => 'Contacto y mapa', 'text' => 'Visita nuestro alquiler de motos en Pelhřimov o contáctanos.', 'btn' => 'CONTACTO', 'href' => '/kontakt'],
                ['icon' => 'gfx/ico-faq.svg', 'title' => 'Preguntas frecuentes', 'text' => 'Las preguntas más habituales sobre el alquiler de motos en un solo lugar.', 'btn' => 'FAQ', 'href' => '/jak-pujcit/faq'],
                ['icon' => 'gfx/ico-trasy.svg', 'title' => 'Rutas en moto', 'text' => 'Descubre las mejores rutas en moto por la República Checa para turistas y locales.', 'btn' => 'RUTAS EN MOTO', 'href' => '/blog'],
            ],
            'motos_section' => [
            ...
            'process' => [
                ...
                'steps' => [
                    ['icon' => 'gfx/ico-step1.svg', 'title' => '1. Elige', 'text' => 'Elige tu moto ideal de nuestra oferta de motos de alquiler.'],
                    ['icon' => 'gfx/ico-step2.svg', 'title' => '2. Reserva', 'text' => 'Reserva tu moto a través de nuestro sencillo sistema online.'],
                    ['icon' => 'gfx/ico-step3.svg', 'title' => '3. Recoge', 'text' => 'Recoge la moto en nuestro alquiler de Pelhřimov.'],
                    ['icon' => 'gfx/ico-step4.svg', 'title' => '4. Disfruta del viaje', 'text' => 'Vive la libertad y descubre la República Checa en motos de alquiler.'],
                ],
            ],
            'faq' => [
        ...
        'pujcovna' => [
            ...
            'benefits' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'gfx/ico-online-rez.svg', 'title' => 'Reserva online', 'text' => 'en unos clics'],
                    ['icon' => 'gfx/ico-vybava.svg', 'title' => 'Equipo del piloto incluido', 'text' => 'casco, chaqueta, pantalones y guantes'],
                    ...
                    ['icon' => 'gfx/ico-pristaveni.svg', 'title' => 'Entrega y recogida', 'text' => 'en el lugar acordado'],
                ],
            ],
            'process' => [
                'title' => 'Cómo funciona el alquiler en Vysočina',
                'steps' => [
                    ['icon' => 'gfx/ico-step1.svg', 'title' => '1. Elige una moto', 'text' => 'Mira nuestra oferta y elige el tipo que se ajuste a ti, a tu experiencia y a tu permiso de conducir.'],
                    ['icon' => 'gfx/ico-step3.svg', 'title' => '2. Reserva online', 'text' => 'Haz tu reserva por fecha o por una moto concreta que quieras alquilar.'],
                    ['icon' => 'gfx/ico-step4.svg', 'title' => '3. Elige el equipo', 'text' => 'El equipo del piloto está incluido; el del pasajero tiene un suplemento. La talla la eliges en el local.'],
                    ['icon' => 'gfx/ico-step5.svg', 'title' => '4. Paga', 'text' => 'Paga fácilmente online a través de la pasarela de pago.'],
                    ['icon' => 'gfx/ico-step6.svg', 'title' => '5. Recoge la moto', 'text' => 'Recoge la moto en el alquiler o en el lugar que elegiste al reservar.'],
                    ['icon' => 'gfx/ico-step7.svg', 'title' => '6. Disfruta del viaje', 'text' => 'Sal a la carretera, descubre nuevas experiencias y disfruta plenamente de la libertad sobre dos ruedas.'],
                    ['icon' => 'gfx/ico-step8.svg', 'title' => '7. Devuelve la moto', 'text' => 'Devuelve la moto el día acordado – directamente en el alquiler o en el lugar acordado.'],
                    ['icon' => 'gfx/ico-sleva.svg', 'title' => 'Descuento para el próximo viaje', 'text' => 'Tras devolver la moto te enviaremos automáticamente un código de descuento de 200 Kč para tu próxima reserva.'],
                ],
            ],
            'faq' => [
                'title' => 'Preguntas frecuentes',
