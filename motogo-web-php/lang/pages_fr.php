...
return [
    'pages' => array_merge($c['pages'], [
        ...
        'home' => [
            ...
            'signposts' => [
                ['icon' => 'gfx/vyber-motorku.svg', 'title' => 'Catalogue de motos', 'text' => 'Découvre notre offre de motos à louer — du sport au tourisme.', 'btn' => 'CATALOGUE DE MOTOS', 'href' => '/katalog'],
                ['icon' => 'gfx/potvrzeni-rezervace.svg', 'title' => 'Comment louer une moto', 'text' => 'Processus simple : choisis une moto, réserve et pars en route.', 'btn' => 'COMMENT LOUER', 'href' => '/jak-pujcit'],
                ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Réservation en ligne', 'text' => 'Réserve ta moto via notre système en ligne facile.', 'btn' => 'RÉSERVER UNE MOTO', 'href' => '/rezervace'],
                ['icon' => 'gfx/kontakt.svg', 'title' => 'Contact et carte', 'text' => 'Visite notre location de motos à Pelhřimov ou contacte-nous.', 'btn' => 'CONTACT', 'href' => '/kontakt'],
                ['icon' => 'gfx/faq.svg', 'title' => 'Foire aux questions', 'text' => 'Les questions les plus fréquentes sur la location de motos en un seul endroit.', 'btn' => 'FAQ', 'href' => '/jak-pujcit/faq'],
                ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => 'Itinéraires moto', 'text' => 'Découvre les meilleurs itinéraires moto en République tchèque pour touristes et locaux.', 'btn' => 'ITINÉRAIRES MOTO', 'href' => '/blog'],
            ],
            'motos_section' => [
            ...
            'process' => [
                ...
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Choisis', 'text' => 'Choisis ta moto idéale dans notre offre de motos à louer.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Réserve', 'text' => 'Réserve ta moto via notre système en ligne simple.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '3. Récupère', 'text' => 'Récupère la moto à notre location à Pelhřimov.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '4. Profite du voyage', 'text' => 'Vis la liberté et découvre la République tchèque sur des motos de location.'],
                ],
            ],
            'faq' => [
        ...
        'pujcovna' => [
            ...
            'benefits' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => 'Réservation en ligne', 'text' => 'en quelques clics'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => 'Équipement pilote inclus', 'text' => 'casque, blouson, pantalon et gants'],
                    ...
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => 'Livraison et reprise', 'text' => 'à un endroit convenu'],
                ],
            ],
            'process' => [
                'title' => 'Comment fonctionne la location en Vysočina',
                'steps' => [
                    ['icon' => 'gfx/vyber-motorku.svg', 'title' => '1. Choisis une moto', 'text' => 'Découvre notre offre et choisis le type qui te convient, à ton expérience et à ton permis.'],
                    ['icon' => 'gfx/rezervace-online.svg', 'title' => '2. Réserve en ligne', 'text' => 'Réserve par date ou par moto précise que tu veux louer.'],
                    ['icon' => 'gfx/vyber-vybavu.svg', 'title' => '3. Choisis l\'équipement', 'text' => 'L\'équipement pilote est inclus, celui du passager est en supplément. La taille se choisit sur place.'],
                    ['icon' => 'gfx/zaplat.svg', 'title' => '4. Paie', 'text' => 'Paie facilement en ligne via la passerelle de paiement.'],
                    ['icon' => 'gfx/predani-motorky.svg', 'title' => '5. Récupère la moto', 'text' => 'Récupère la moto directement à la location, ou à l\'endroit choisi lors de la réservation.'],
                    ['icon' => 'gfx/uzij-si-jizdu.svg', 'title' => '6. Profite du voyage', 'text' => 'Prends la route, découvre de nouvelles expériences et profite pleinement de la liberté à deux roues.'],
                    ['icon' => 'gfx/vrat-motorku-vcas.svg', 'title' => '7. Rends la moto', 'text' => 'Rends simplement la moto le jour convenu – à la location ou à un endroit convenu.'],
                    ['icon' => 'gfx/sleva-na-pristi-jizdu.svg', 'title' => 'Réduction pour la prochaine balade', 'text' => 'Après le retour de la moto nous t\'envoyons automatiquement un code de réduction de 200 Kč pour ta prochaine réservation.'],
                ],
            ],
            'faq' => [
                'title' => 'Foire aux questions',
