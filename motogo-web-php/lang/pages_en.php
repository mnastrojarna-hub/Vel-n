...
return [
    'pages' => array_merge($c['pages'], [
        ...
        'home' => [
            ...
            'signposts' => [
                ['icon' => 'gfx/ico-katalog.svg', 'title' => 'Motorcycle catalog', 'text' => 'Browse our offer of motorcycles for rent — from sport to touring models.', 'btn' => 'MOTORCYCLE CATALOG', 'href' => '/katalog'],
                ['icon' => 'gfx/ico-jak.svg', 'title' => 'How to rent a motorcycle', 'text' => 'A simple process: choose a motorcycle to rent, book and ride.', 'btn' => 'HOW TO RENT', 'href' => '/jak-pujcit'],
                ['icon' => 'gfx/ico-rezervace.svg', 'title' => 'Online motorcycle booking', 'text' => 'Book a motorcycle for rent through our easy online system.', 'btn' => 'BOOK A MOTORCYCLE', 'href' => '/rezervace'],
                ['icon' => 'gfx/ico-kontakt.svg', 'title' => 'Contacts and map', 'text' => 'Visit our motorcycle rental in Pelhřimov or contact us.', 'btn' => 'CONTACT', 'href' => '/kontakt'],
                ['icon' => 'gfx/ico-faq.svg', 'title' => 'Frequently asked questions', 'text' => 'The most common questions about renting a motorcycle in one place.', 'btn' => 'FAQ', 'href' => '/jak-pujcit/faq'],
                ['icon' => 'gfx/ico-trasy.svg', 'title' => 'Motorcycle trips', 'text' => 'Discover the best motorcycle routes in the Czech Republic for tourists and locals.', 'btn' => 'MOTORCYCLE ROUTES', 'href' => '/blog'],
            ],
            'motos_section' => [
            ...
            'process' => [
                ...
                'steps' => [
                    ['icon' => 'gfx/ico-step1.svg', 'title' => '1. Choose', 'text' => 'Pick your ideal motorcycle from our offer of motorcycles for rent.'],
                    ['icon' => 'gfx/ico-step2.svg', 'title' => '2. Book', 'text' => 'Book your motorcycle rental through our simple online system.'],
                    ['icon' => 'gfx/ico-step3.svg', 'title' => '3. Pick up', 'text' => 'Pick up the motorcycle at our rental in Pelhřimov.'],
                    ['icon' => 'gfx/ico-step4.svg', 'title' => '4. Enjoy the ride', 'text' => 'Embrace the freedom and discover the Czech Republic on rental motorcycles.'],
                ],
            ],
            'faq' => [
        ...
        'pujcovna' => [
            ...
            'benefits' => [
                ...
                'items' => [
                    ...
                    ['icon' => 'gfx/ico-online-rez.svg', 'title' => 'Online booking', 'text' => 'in just a few clicks'],
                    ['icon' => 'gfx/ico-vybava.svg', 'title' => 'Rider gear included', 'text' => 'helmet, jacket, trousers and gloves'],
                    ...
                    ['icon' => 'gfx/ico-pristaveni.svg', 'title' => 'Motorcycle delivery & pickup', 'text' => 'to an agreed place'],
                ],
            ],
            'process' => [
                'title' => 'How motorcycle rental works in Vysočina',
                'steps' => [
                    ['icon' => 'gfx/ico-step1.svg', 'title' => '1. Pick a motorcycle', 'text' => 'Browse our offer and choose the type that suits you, your experience and your licence.'],
                    ['icon' => 'gfx/ico-step3.svg', 'title' => '2. Book online', 'text' => 'Reserve by date or by a specific motorcycle you want to rent.'],
                    ['icon' => 'gfx/ico-step4.svg', 'title' => '3. Choose gear', 'text' => 'Rider gear is included; passenger gear costs extra. You can choose the size on site.'],
                    ['icon' => 'gfx/ico-step5.svg', 'title' => '4. Pay', 'text' => 'Pay easily online through the payment gateway.'],
                    ['icon' => 'gfx/ico-step6.svg', 'title' => '5. Pick up the motorcycle', 'text' => 'Pick up the motorcycle directly at the rental, or at the place you selected when booking.'],
                    ['icon' => 'gfx/ico-step7.svg', 'title' => '6. Enjoy the ride', 'text' => 'Hit the road, discover new experiences and enjoy the full freedom of two wheels.'],
                    ['icon' => 'gfx/ico-step8.svg', 'title' => '7. Return the motorcycle', 'text' => 'Simply return the motorcycle on the agreed day – at the rental, or at the agreed place.'],
                    ['icon' => 'gfx/ico-sleva.svg', 'title' => 'Discount for your next ride', 'text' => 'After returning the motorcycle, we\'ll automatically send you a 200 Kč discount code for your next booking.'],
                ],
            ],
            'faq' => [
                'title' => 'Frequently asked questions',
