...
return [
    ...
    'header.app.aria' => 'Stáhnout mobilní aplikaci MotoGo24 z Google Play nebo App Store',
    'header.app.heading' => 'Stáhni si appku MotoGo24',
    'header.app.qrAlt' => 'QR kód pro stažení aplikace MotoGo24 z Google Play (Android)',
    'header.app.qrAltIos' => 'QR kód pro stažení aplikace MotoGo24 z App Store (iPhone)',
    'header.app.getPlay' => 'Google Play — Android',
    'header.app.getIos' => 'App Store — iPhone',
    'header.app.whitelist' => 'Appka je zdarma — pro Android na Google Play i pro iPhone v App Store. Naskenuj QR kód svého obchodu nebo klepni na tlačítko a nainstaluj.',
    ...
    'rez.contact.companyToggle' => 'Firemní údaje (nákup na firmu)',
    'rez.contact.companyName' => 'Název firmy',
    'rez.contact.companyIco' => 'IČO',
    'rez.contact.companyDic' => 'DIČ',
    'rez.contact.companyAddress' => 'Adresa firmy (sídlo)',
    ...
    'rez.pickup.deliveryTip' => 'Motorku vám dovezeme na domluvené místo. Cena: {base} + {perKm}/km od pobočky Mezná 9, 393 01 Pelhřimov. Trasu spočítáme automaticky po zadání adresy.',
    ...
    'rez.pickup.returnTip' => 'Motorku vám rádi vyzvedneme jinde. Cena: {base} + {perKm}/km od pobočky Mezná 9, 393 01 Pelhřimov. Trasu spočítáme automaticky po zadání adresy.',
    ...
    'editRez.loc.atRental' => 'V půjčovně Mezná 9, 393 01 Pelhřimov',
    ...
    'editRez.pay.trailerStaffedOnly' => 'Vozík lze půjčit jen k motorce z obslužné pobočky — samoobslužná ho nevydává. Vyberte motorku z obslužné pobočky, nebo z rezervace odeberte vozík. Platba doplatku zrušena.',
    'editRez.pay.trailerOccupied' => 'Vozík je v novém termínu už obsazený jinou rezervací. Zvolte jiný termín, nebo z rezervace odeberte vozík. Platba doplatku zrušena.',
    'editRez.pay.checkUnavailable' => 'Nepodařilo se ověřit vozík u rezervace — platba doplatku zrušena, zkuste to prosím za chvíli znovu.',
    'editRez.pay.validationUnavailable' => 'Nepodařilo se ověřit změnu rezervace — platba doplatku zrušena, zkuste to prosím za chvíli znovu.',
    'editRez.pay.notFound' => 'Rezervace nebyla nalezena — platba doplatku zrušena. Obnovte stránku a zkuste znovu.',
    ...
    'editRez.history.pickupTimeChanged' => '🕐 Čas vyzvednutí: <s>{from}</s> → <strong>{to}</strong>',
    'editRez.history.returnTimeChanged' => '🕐 Čas vrácení: <s>{from}</s> → <strong>{to}</strong>',
    'editRez.history.gearChanged' => '🧤 Změna výbavy',
    'editRez.history.extrasChanged' => '➕ Změna doplňků',
    'editRez.history.sourceCustomer' => 'Zákazník',
    'editRez.history.gearItem' => '{label}{pass}: <s>{from}</s> → <strong>{to}</strong>',
    'editRez.history.passengerShort' => ' (spolujezdec)',
    'editRez.gear.none' => 'Bez výbavy',
    ...
    'confirm.qrdocs.titleWait' => 'Rezervace uložena, čekáme na platbu',
    'confirm.qrdocs.leadNumbers' => 'Údaje z dokladů máme uložené. Fotky dokladů jsou nepovinné — můžeš je kdykoli doplnit v úpravě rezervace. Rezervaci dokončíme, jakmile dorazí vaše platba.',
    'confirm.qrdocs.leadNoDocs' => 'Rezervaci dokončíme, jakmile dorazí vaše platba. Poté prosím ještě doplň doklady, ať ti můžeme poslat smlouvu a přístupové kódy k motorce.',
