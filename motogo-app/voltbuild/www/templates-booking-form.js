  ...
  <div class="bcard">
    ...
    <div id="contact-expanded" style="display:none;margin-top:10px;">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:9px;">
        ...
        <div class="ff" style="margin:0;position:relative;"><label id="t-bkStreet">Ulice, č.p.</label><input type="text" id="b-contact-street" value="" oninput="showAddrSuggestions(this,'b-contact')" autocomplete="off"><div id="b-contact-addr-suggestions" class="addr-suggestions" style="display:none;"></div></div>
      </div>
