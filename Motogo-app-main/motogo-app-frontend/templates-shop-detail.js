...
Templates['s-cart'] = `  <div class="topbar">
  ...
  <div style="padding:16px 20px;">
    ...
    <button id="t-sdProceed" class="btn-g" onclick="checkoutMerch()">K platbě →</button>
  </div>`;
...
Templates['s-checkout'] = `  <div class="topbar">
  ...
  <div style="position:sticky;bottom:0;left:0;right:0;padding:12px 20px;background:#fff;box-shadow:0 -4px 16px rgba(0,0,0,.08);z-index:50;">
    <button id="t-sdConfirmPay" class="btn-g" onclick="finalizeCheckout()" style="margin:0;">✅ Potvrdit a zaplatit →</button>
  </div>`;
