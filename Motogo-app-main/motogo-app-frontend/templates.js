...
Templates['s-login'] = `  <div class="lt">
    <div style="position:relative;z-index:2;text-align:center;">
      <div style="display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:4px;">
        <img src="${IMG_BASE64_0}" style="width:52px;height:52px;border-radius:14px;object-fit:contain;background:#000;" alt="MotoGo24">
        <div style="font-size:28px;font-weight:900;color:#fff;letter-spacing:-.5px;line-height:1;white-space:nowrap;">MOTO GO 24</div>
      </div>
    </div>
  ...
  <div class="ls">
    ...
    <button class="btn-out" id="t-registerBtn" onclick="goTo('s-register')">Registrovat se</button>
...
Templates['s-register'] = `  <div class="reg-hdr">
  ...
  <div class="bcard" style="margin-top:14px;">
    <div class="reg-step active" id="reg-step-1">
      <div class="reg-step-title" id="t-s1t">👤 Krok 1 / 3 – Základní údaje</div>
    ...
    <div class="reg-step" id="reg-step-2">
      <div class="reg-step-title" id="t-s2t">🏠 Krok 2 / 3 – Adresa bydliště</div>
      ...
      <div style="display:grid;grid-template-columns:2fr 1fr;gap:9px;">
        <div class="ff" style="margin:0;"><label id="t-city">Obec / město</label><input id="reg-city" type="text" placeholder="např. Praha, Hojanivice"></div>
        <div class="ff" style="margin:0;"><label id="t-zip">PSČ</label><input id="reg-zip" type="text" placeholder="110 00"></div>
      </div>
      <div class="ff" style="margin-top:9px;"><label id="t-street">Ulice a č.p. / č.o.</label><input id="reg-street" type="text" placeholder="např. Vodičkova 36, Mezná 9"></div>
