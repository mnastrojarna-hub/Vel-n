...
class PriceSummaryCard extends StatelessWidget {
  ...
  final List<BookingUpsellItem> upsellItems;
  ...
  double get _upsellTotal =>
      upsellItems.fold(0, (s, i) => s + i.price);

  double get _totalWithUpsell => breakdown.total + _upsellTotal;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(t(context).priceSummary, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: MotoGoColors.black)),
