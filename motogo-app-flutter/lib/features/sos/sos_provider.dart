...
/// Create SOS incident via create_sos_incident RPC.
/// DB: create_sos_incident(p_type, p_booking_id, p_lat, p_lng, p_description, p_is_fault)
Future<String?> createSosIncident({
  ...
  try {
    ...
    // Use create_sos_incident RPC for proper validation & triggers
    // DB: create_sos_incident(p_type, p_booking_id, p_lat, p_lng, p_description, p_is_fault)
    final res = await MotoGoSupabase.client.rpc('create_sos_incident', params: {
      'p_type': type,
