...
class SosReportScreen extends ConsumerWidget {
  ...
  Future<void> _report(BuildContext context, WidgetRef ref, String type, String desc) async {
    ...
    // 3. Create incident FIRST via RPC with GPS
    ...
    if (incId == null) {
      if (context.mounted) showMotoGoToast(context, icon: '✗', title: t(context).error, message: t(context).tr('incidentCreateFailed'));
      return;
    }
