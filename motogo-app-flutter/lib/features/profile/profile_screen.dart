...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverList.list(children: [
              ...
              ProfileMenuItem(icon: '🔐', label: t(context).tr('biometric'), onTap: () => _showBiometricToggle(context)),
  ...
  void _showBiometricToggle(BuildContext context) => showBiometricToggleSheet(context);
}
