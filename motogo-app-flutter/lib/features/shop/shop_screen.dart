      ...
      body: CustomScrollView(
        slivers: [
                      ...
                      Row(children: [
                        ClipRRect(
                          ...
                          child: Image.asset('assets/logo.png', width: 28, height: 28, fit: BoxFit.cover,
                            errorBuilder: (_, __, ___) => Container(width: 28, height: 28, decoration: BoxDecoration(color: MotoGoColors.green, borderRadius: BorderRadius.circular(8)), child: const Icon(Icons.motorcycle, size: 16, color: Colors.white))),
                        ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                Text(t(context).tr('buyVoucher'), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Colors.white)),
                              ]),
                            ),
                          ],
                        ),
          ...
          productsAsync.when(
            ...
            error: (_, __) => SliverFillRemaining(child: Center(child: Text(t(context).tr('error')))),
          ),
        ],
      ),
    );
