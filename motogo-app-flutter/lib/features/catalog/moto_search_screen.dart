  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (context) {
          try {
            return _buildContent(context, motosAsync);
          } catch (e) {
            return Center(child: Text('${t(context).tr('catalogErrorPrefix')}$e', style: const TextStyle(color: MotoGoColors.red)));
          }
        },
      ),
    );
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Center(
                          child: Text('1', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: Colors.white)),
                        ),
                      ),
