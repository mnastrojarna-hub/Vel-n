      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 6,
            children: [
              MapEntry('cestování', t(context).tr('filtersUsageTravel')),
              MapEntry('sport', t(context).tr('filtersUsageSport')),
              MapEntry('město', t(context).tr('filtersUsageCity')),
              MapEntry('terén', t(context).tr('filtersUsageTerrain')),
              MapEntry('výlet', t(context).tr('filtersUsageTrip')),
            ].map((entry) {
              final tag = entry.key;
              final label = entry.value;
              final active = filter.usageTags.contains(tag);
              return GestureDetector(
                onTap: () {
                  final tags = List<String>.from(filter.usageTags);
                  ...
                  ref.read(catalogFilterProvider.notifier).state =
                      filter.copyWith(usageTags: tags);
                },
                child: Container(
