        ...
        slivers: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.asset('assets/logo.png', width: 28, height: 28, fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => Container(width: 28, height: 28,
                          ...
                          child: const Icon(Icons.motorcycle, size: 16, color: Colors.white))),
                    ),
          ...
          reservationsAsync.when(
            ...
            error: (_, __) => SliverFillRemaining(
              child: Center(child: Text(t(context).tr('loadingError'), style: const TextStyle(color: MotoGoColors.red))),
            ),
          ),
        ],
      ),
