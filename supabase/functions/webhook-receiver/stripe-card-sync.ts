...
/** Sync card details from a setup session (add card flow) to Supabase */ export async function syncCardFromSetupSession(supabase, session) {
  try {
...
/** Sync all cards for a Stripe customer to Supabase payment_methods table */ export async function syncCardsForCustomer(supabase, customerId) {
  try {
