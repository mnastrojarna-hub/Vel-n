...
export const FLEET_CALC = {
  ...
  categoryParams: {
    adventure: {
      avgDailyRate: 2100,
      avgServicePerEvent: 25000,
      servicesPerYear: 2,
      insuranceCleaningYear: 13000,
      avgPurchasePrice: 200000
    },
    touring: {
      avgDailyRate: 2000,
      avgServicePerEvent: 20000,
      servicesPerYear: 2,
      insuranceCleaningYear: 13000,
      avgPurchasePrice: 220000
    },
    naked: {
      avgDailyRate: 1600,
      avgServicePerEvent: 20000,
    ...
    retro: {
      avgDailyRate: 1400,
      avgServicePerEvent: 10000,
      servicesPerYear: 3,
      insuranceCleaningYear: 13000,
      avgPurchasePrice: 110000
    },
    A2: {
      avgDailyRate: 1100,
      avgServicePerEvent: 10000,
      servicesPerYear: 2,
      insuranceCleaningYear: 7000,
      avgPurchasePrice: 50000
    },
    detske: {
      avgDailyRate: 800,
      avgServicePerEvent: 8000,
      servicesPerYear: 2,
      insuranceCleaningYear: 5000,
      avgPurchasePrice: 30000
    },
    enduro: {
      avgDailyRate: 1800,
      avgServicePerEvent: 15000,
      servicesPerYear: 3,
      insuranceCleaningYear: 13000,
      avgPurchasePrice: 180000
    },
    cestovni: {
      avgDailyRate: 2000,
      avgServicePerEvent: 20000,
    ...
    chopper: {
      avgDailyRate: 1500,
      avgServicePerEvent: 18000,
      servicesPerYear: 2,
      insuranceCleaningYear: 13000,
      avgPurchasePrice: 190000
    }
  },
  branchUtilization: {
    'turistická': {
...
export async function fetchAnalyticsRawData(sb, months) {
