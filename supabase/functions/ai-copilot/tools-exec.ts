...
const WRITE_TOOLS = new Set([
  ...
  'update_motorcycle',
  'update_motorcycle_pricing',
  'update_branch',
  'update_branch_accessories',
  'update_customer',
...
export async function executeTool(toolName, toolInput, supabaseAdmin, dryRun = false, supabaseUser) {
