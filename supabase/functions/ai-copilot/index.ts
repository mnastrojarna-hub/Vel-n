...
const TOOLS_DEFINITION = [
  ...
  },
  {
    ...
    description: 'Analýza výkonnosti poboček — tržby, využití, trend, profit/motorku',
    input_schema: {
      type: 'object' as const,
      properties: {
        period_months: { type: 'number', description: 'Období v měsících zpět (default 6)' },
      },
      required: [],
    },
  },
  {
    ...
    description: 'Analýza výkonnosti motorek — tržby, využití, denní sazba, srovnání značek',
    input_schema: {
      type: 'object' as const,
      properties: {
        period_months: { type: 'number', description: 'Období v měsících zpět (default 6)' },
  ...
  },
  {
    ...
    description: 'Analýza poptávky dle kategorie motorek — počty, tržby, využití',
    input_schema: {
      type: 'object' as const,
      properties: {
        period_months: { type: 'number', description: 'Období v měsících zpět (default 6)' },
  ...
  },
  {
    ...
    description: 'Optimální složení flotily pro konkrétní pobočku — doporučení rozložení kategorií na 8 slotů',
    input_schema: {
      type: 'object' as const,
      properties: {
        branch_id: { type: 'string', description: 'UUID pobočky' },
  ...
  },
  {
    ...
    description: 'Analýza zákazníků — segmentace (VIP/Regular/Occasional/Inactive), top zákazníci, preference kategorií, zdroje',
    input_schema: {
      type: 'object' as const,
      properties: {
        period_months: { type: 'number', description: 'Období v měsících zpět (default 12)' },
      },
      required: [],
    },
  },
  {
    ...
    description: 'Predikce na základě historických dat: očekávané tržby, obsazenost, sezónnost. Lineární trend + sezónní koeficienty.',
    input_schema: {
      type: 'object' as const,
      properties: {
        months_ahead: { type: 'number', description: 'Počet měsíců dopředu (default 3)' },
        branch_id: { type: 'string', description: 'UUID pobočky (volitelné — bez něj celá firma)' },
      },
      required: [],
    },
  },
