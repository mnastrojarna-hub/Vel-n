...
/** Kurátorské překlady OTP mailu (auth-kritický → bez API latence). */ const OTP_L = {
  ...
  uk: {
    subject: 'Скидання пароля — код підтвердження',
    title: 'Скидання пароля',
    intro: 'Щоб скинути пароль, введіть наведений нижче код підтвердження на сайті MotoGo24. Одразу після цього ви встановите новий пароль. Код дійсний',
    hour: '1 годину',
    ignore: 'Якщо ви не просили скинути пароль, просто проігноруйте цей лист. Ваш пароль залишиться без змін.',
    team: 'Команда MotoGo24',
    auto: 'Цей лист згенеровано автоматично.'
  }
};
