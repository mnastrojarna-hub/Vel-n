...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_16" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_16" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_17" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_17" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_18" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_18" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_19" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_19" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_20" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_20" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_21" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_21" OWNER TO "supabase_realtime_admin";
...
CREATE POLICY "branch_music_admin_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'branch-music'::"text") AND "public"."is_admin"()));



CREATE POLICY "branch_music_admin_insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'branch-music'::"text") AND "public"."is_admin"()));



CREATE POLICY "branch_music_admin_update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'branch-music'::"text") AND "public"."is_admin"())) WITH CHECK ((("bucket_id" = 'branch-music'::"text") AND "public"."is_admin"()));



CREATE POLICY "branch_music_public_select" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'branch-music'::"text"));
...
CREATE POLICY "media_ride_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'media'::"text") AND (("storage"."foldername"("name"))[1] = 'rides'::"text") AND ((("storage"."foldername"("name"))[2] = ("auth"."uid"())::"text") OR "public"."is_admin"())));



CREATE POLICY "media_ride_upload" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'media'::"text") AND (("storage"."foldername"("name"))[1] = 'rides'::"text")));
...
GRANT ALL ON TABLE "realtime"."messages_2026_09_17" TO "postgres";
GRANT ALL ON TABLE "realtime"."messages_2026_09_17" TO "dashboard_user";
