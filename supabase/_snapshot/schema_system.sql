...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_23" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_24" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_25" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_26" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_09_27" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_09_27" OWNER TO "supabase_realtime_admin";
...
GRANT REFERENCES,DELETE,TRIGGER,TRUNCATE,MAINTAIN,UPDATE ON TABLE "realtime"."messages_2026_09_27" TO "postgres";
GRANT SELECT,INSERT ON TABLE "realtime"."messages_2026_09_27" TO "postgres" WITH GRANT OPTION;
GRANT ALL ON TABLE "realtime"."messages_2026_09_27" TO "dashboard_user";
