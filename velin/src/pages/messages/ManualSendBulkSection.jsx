...
import { CHANNEL_LABELS, BULK_SEGMENTS, COUNTRY_OPTIONS, LANGUAGE_OPTIONS } from './messageHelpers'

export default function ManualSendBulkSection({
  sendType, setSendType, bulkSegment, setBulkSegment,
  bulkCountry, setBulkCountry, bulkLanguage, setBulkLanguage,
  bulkRecipientCount, bulkCountLoading,
  selectedCustomer, customerSearch, setCustomerSearch,
  customers, loadingCustomers, selectCustomer, clearCustomer,
  recipientWarning, channel,
}) {
  return (
    <>
