            ...
            <tbody>
              {motos.map(m => {
                ...
                >
                  ...
                  <TD>
                    {thumb ? (
                      <img src={thumb} alt={m.model} loading="lazy" decoding="async" style={{ width: 48, height: 36, objectFit: 'cover', borderRadius: 6, background: '#f1faf7' }} onError={e => { e.target.style.display = 'none'; e.target.parentElement.innerHTML = '<div style="width:48px;height:36px;border-radius:6px;background:#f1faf7;display:flex;align-items:center;justify-content:center;font-size:16px;color:#1a2e22">🏍️</div>' }} />
                    ) : (
...
// AddMotoModal moved to ./FleetAddMotoModal.jsx
