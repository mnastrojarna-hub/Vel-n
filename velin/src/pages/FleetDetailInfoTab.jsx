      ...
      <Card>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: '#5b7065' }}>Řídí pořadí na webu (výběr stroje v rezervaci, katalog, pořadí fotek/videí v hero banneru na úvodní stránce) i výchozí pořadí motorek v mobilní appce. Nižší číslo = dřív. Prázdné se řadí za očíslované podle modelu.</p>
          </div>
