  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'web.layout.editRez.loc.help', label: 'Pomocný text (nadcházející rezervace)', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.helpActive', label: 'Pomocný text (probíhající rezervace)', type: 'textarea', default: 'Probíhající rezervaci už můžete měnit jen na straně vrácení (motorku máte vyzvednutou).' },
        { key: 'web.layout.editRez.loc.refundNote', label: 'Banner „Storno se nevztahuje na změnu místa"', type: 'textarea', default: 'Změna místa nepodléhá storno tabulce — vratku za přistavení dostanete vždy v plné výši.' },
        { key: 'web.layout.editRez.loc.pickupLockedTitle', label: 'Banner pickup zamčen — nadpis', default: 'Vyzvednutí už proběhlo' },
        { key: 'web.layout.editRez.loc.pickupLockedHelp', label: 'Banner pickup zamčen — popis', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.headPickup', label: 'Sekce „Vyzvednutí motorky"', default: '📥 Vyzvednutí motorky' },
        { key: 'web.layout.editRez.loc.headReturn', label: 'Sekce „Vrácení motorky"', default: '📤 Vrácení motorky' },
        { key: 'web.layout.editRez.loc.atRentalTitle', label: 'Karta „V půjčovně" — nadpis', default: 'V půjčovně Mezná' },
        { key: 'web.layout.editRez.loc.atRentalDescPickup', label: 'Karta „V půjčovně" (vyzvednutí) — popis', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.atRentalDescReturn', label: 'Karta „V půjčovně" (vrácení) — popis', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.deliveryTitle', label: 'Karta „Přistavení" — nadpis', default: 'Přistavení na adresu' },
        { key: 'web.layout.editRez.loc.deliveryDescPickup', label: 'Karta „Přistavení" — popis (vyzvednutí)', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.deliveryReturnTitle', label: 'Karta „Odvoz" — nadpis', default: 'Odvoz z adresy' },
        { key: 'web.layout.editRez.loc.deliveryDescReturn', label: 'Karta „Odvoz" — popis (vrácení)', type: 'textarea', default: '' },
        { key: 'web.layout.editRez.loc.addrPlaceholder', label: 'Placeholder adresy', default: 'Zadejte adresu (ulice, město)' },
        { key: 'web.layout.editRez.loc.pickOnMapBtn', label: 'Tlačítko „Vybrat na mapě"', default: 'Vybrat na mapě' },
        ...
        { key: 'web.layout.editRez.loc.cta', label: 'Tlačítko CTA „Uložit změnu"', default: 'Uložit změnu' },
        { key: 'web.layout.editRez.loc.confirm', label: 'Dialog „Uložit změnu?"', default: 'Uložit změnu?' },
        ...
        { key: 'web.layout.editRez.loc.timeOnly', label: 'Řádek „Změna jen času (zdarma)"', default: 'Změna času (zdarma)' },
      ]
    },
    {
