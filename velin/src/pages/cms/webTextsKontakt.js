  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'web.layout.rez.pickup.deliveryTip', label: 'Tooltip „Přistavení"', type: 'textarea', default: 'Motorku vám dovezeme na domluvené místo. Cena: {base} + {perKm}/km od pobočky Mezná 9, 393 01 Pelhřimov. Trasu spočítáme automaticky po zadání adresy.' },
        ...
        { key: 'web.layout.rez.pickup.returnTip', label: 'Tooltip „Vrácení jinde"', type: 'textarea', default: 'Motorku vám rádi vyzvedneme jinde. Cena: {base} + {perKm}/km od pobočky Mezná 9, 393 01 Pelhřimov. Trasu spočítáme automaticky po zadání adresy.' },
