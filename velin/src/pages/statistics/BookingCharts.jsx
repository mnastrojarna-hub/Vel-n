...
export function BookingsByStatus() {
  ...
  return (
    <Card>
      <h3 className="text-sm font-extrabold uppercase tracking-wide mb-3" style={{ color: '#1a2e22' }}>Rezervace podle statusu</h3>
        ...
        <div className="flex-1 space-y-2">
          {data.map(d => (
            <div key={d.name} className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium" style={{ color: '#1a2e22' }}>{d.name}</span>
              <span className="ml-auto text-sm font-bold" style={{ color: '#0f1a14' }}>{d.value}</span>
            </div>
          ))}
        </div>
      </div>
...
export function CustomerRetention() {
  ...
  return (
    <Card>
      <h3 className="text-sm font-extrabold uppercase tracking-wide mb-3" style={{ color: '#1a2e22' }}>Zákaznická retence</h3>
