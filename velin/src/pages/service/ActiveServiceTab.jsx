...
/* ═══ Unavailable MotoCard — dočasně vyřazená ze servisu ═══ */
function UnavailableMotoCard({ m, logs: mLogs, expanded, setExpanded, onAction, onReload }) {
  const isExp = expanded[m.id]
...
/* ═══ NoLogCard — moto v servisu bez záznamu ═══ */
