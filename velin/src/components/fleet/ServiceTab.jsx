...
function getServiceItems(description) {
  ...
  if (desc.includes('olej')) return ['Vypustit stary olej', 'Vymenit olejovy filtr', 'Doplnit novy olej dle specifikace', 'Zkontrolovat unik oleje']
  if (desc.includes('pneumat')) return ['Demontovat kola', 'Namontovat nove pneumatiky', 'Vyvazit kola', 'Zkontrolovat brzdove desticky']
  if (desc.includes('kompletni') || desc.includes('servis')) return ['Vymena oleje a filtru', 'Kontrola brzd', 'Kontrola retezu/rozvodu', 'Kontrola elektroinstalace', 'Kontrola pneumatik', 'Serizeni ventilu', 'Kontrola chladici kapaliny', 'Celkova vizualni kontrola']
  return ['Provest servisni ukon dle popisu', 'Vizualni kontrola', 'Zkusebni jizda']
}
